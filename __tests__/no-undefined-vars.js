...
const pluginPath = require.resolve('../plugins/no-undefined-vars')
...
describe('primer/no-undefined-vars', () => {
  ...
  it('test', () => {
    return stylelint.lint({code: '.text-gray { color: #111; }', config: configWithOptions(true)}).then(data => {
      expect(data).not.toHaveErrored()
